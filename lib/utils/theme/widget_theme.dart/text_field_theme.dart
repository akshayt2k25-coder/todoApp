...
class UTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: USizes.fontSizeMd, color: UColors.black),
    hintStyle: const TextStyle()
        .copyWith(fontSize: USizes.fontSizeSm, color: UColors.black),
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal),
    floatingLabelStyle:
        const TextStyle().copyWith(color: UColors.black.withOpacity(0.8)),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    suffixIconColor: UColors.darkGrey,
    labelStyle: const TextStyle()
        .copyWith(fontSize: USizes.fontSizeMd, color: UColors.white),
    hintStyle: const TextStyle()
        .copyWith(fontSize: USizes.fontSizeSm, color: UColors.white),
    floatingLabelStyle:
        const TextStyle().copyWith(color: UColors.white.withOpacity(0.8)),
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(USizes.inputFieldRadius),
